const myRequest = (method, url, out, body) => {
	fetch(url, {
		...
		.then(response => {
			document.querySelector(out).innerText = response;
		})
}
...
function t1() {
	myRequest('GET', `${url}?${key}&action=1`, '.out-1');
}
...
function t2() {
	myRequest('GET', `${url}?${key}&action=2&name=Vitali`,'.out-2');
}
...
function t3() {
	myRequest('GET', `${url}?${key}&action=3&num1=2&num2=25`,'.out-3');
}
...
function t4() {
	myRequest('GET', `${url}?${key}&action=4&num1=3&num2=43`,'.out-4');
}
...
function t5() {
	myRequest('GET', `${url}?${key}&action=5`,'.out-5');
}
...
function t6() {
	myRequest('GET', `${url}?${key}&action=6&num1=32&num2=225`,'.out-6');
}
...
function t7() {
	myRequest('GET', `${url}?${key}&action=7`,'.out-7');
}
...
function t8() {
	myRequest('GET', `${url}?${key}&action=8&year=1989`,'.out-8');
}
...
function t9() {
	myRequest('GET', `${url}?${key}&action=9&m=1&d=1&y=1`,'.out-9');
}
...
function t10() {
	myRequest('POST', url,'.out-10', `${key}&action=1&y=1`);
}
...
function t11() {
	myRequest('POST', url,'.out-11', `${key}&action=2&name=Vitali`);
}
...
function t12() {
	myRequest('POST', url,'.out-12', `${key}&action=3&num1=3&num2=324`);
}
...
function t13() {
	myRequest('POST', url,'.out-13',`${key}&action=4&num1=23&num2=34`);
}
...
function t14() {
	myRequest('POST', url,'.out-14', `${key}&action=5&`);
}
...
function t15() {
	myRequest('POST', url,'.out-15', `${key}&action=6&num1=7&num2=18`);
}
...
function t16() {
	myRequest('POST', url,'.out-16', `${key}&action=7&`);
}
...
function t17() {
	myRequest('POST', url,'.out-17', `${key}&action=8&year=1989`);
}
...
function t18() {
	myRequest('POST', url,'.out-18', `${key}&action=9&m=1&d=1&y=1`);
}
