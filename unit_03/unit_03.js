...
function f3(){
    ...
    if( num1 > num2 ) {
        document.querySelector('.out-3').textContent = num1;
    }
    else {
        document.querySelector('.out-3').textContent = num2;
    }
...
function f4(){
    let age = 2020 - (+document.querySelector('.i-4').value);
...
function f6(){
    let num = (+document.querySelector('.i-6').value) % 2;
...
function f7(){
    ...
    document.querySelector('.out-7').textContent = Math.pow(num1, num2);

    document.querySelector('.i-71').value = '';
    document.querySelector('.i-72').value = '';
...
function f9(){
    ...
    if(num >= 1 && num <= 32 ) {
        document.querySelector('.out-9').textContent = 'Ваш подъезд ' + 1;
    }
    else if(num >= 33 && num <= 43) {
        document.querySelector('.out-9').textContent = 'Ваш подъезд ' + 2;
    }
    else if(num >= 44 && num <= 64) {
        document.querySelector('.out-9').textContent = 'Ваш подъезд ' + 3;
    }
    else {
...
function f10(){
    ...
    switch(select) {
        case 6:
            document.querySelector('.out-10').textContent = 'six';
            break;
        case 7:
            document.querySelector('.out-10').textContent = 'seven';
            break;
        case 11:
            document.querySelector('.out-10').textContent = 'eleven';
            break;
        case 9:
            document.querySelector('.out-10').textContent = 'nine';
            break;
    }
...
function f11(){
    ...
    switch(select) {
        case 6:
            document.querySelector('.out-11').textContent = 'six';
            break;
        case 7:
            document.querySelector('.out-11').textContent = 'seven';
            break;
        case 11:
            document.querySelector('.out-11').textContent = 'eleven';
            break;
        case 9:
            document.querySelector('.out-11').textContent = 'nine';
            break;
    }
}
...
function f13(){
    ...
    document.querySelector('.out-13').innerHTML = (typeof v); //JS из инпута получает всё в виде строки
}
...
function f14(){
    ...
    switch (s) {
        case '+':
            document.querySelector('.out-14').textContent = num1 + num2;
            break;
        case '-':
            document.querySelector('.out-14').textContent = num1 - num2;
            break;
    ...
    document.querySelector('.i-141').value = '';
    document.querySelector('.i-142').value = '';
...
function f15(){
    ...
    if (sel3 == '&&') {
        document.querySelector('.out-15').textContent = sel1 + sel3 + sel2;
    }
    else {
        document.querySelector('.out-15').textContent = sel1 + sel3 + sel2;
    }
