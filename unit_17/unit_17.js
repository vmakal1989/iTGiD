...
function t2() {
    return a2_res = a2.map(elem => Math.pow(elem,2));
}
...
function t3() {
    return a3_res = a3.map(elem => +elem);
}
...
function t4() {
    a4.map(elem => typeof elem === "number" ? a4_res.push(elem) : false);
    return a4_res;
}
...
function t5() {
    return b1_res = b1.filter(elem => elem % 2 === 0 );
}
...
function t6() {
    return b6_res = b6.filter(elem => typeof elem === "number");
}
...
function t7() {
    return b7_res = b7.filter(elem => typeof elem === "string" && elem.length > 3);
}
...
function t8() {
    b8.filter((elem, index) => {
        if(elem % 2 === 0 && typeof elem === 'number') b8_res.push(index);
    });
    return b8_res
}
...
function t10() {
    return b10_res = b10.filter(elem => {
        for(let item of elem) {
            if(item === 3) return elem;
        }
    })
