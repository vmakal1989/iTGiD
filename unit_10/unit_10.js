...
let ar1 = ['Hello', true, 1]; // переменную обьявляем здесь!!!!

function f1() {
    document.querySelector('div.out-1').innerHTML = ar1; // да так можно выводить!!!!
}
...
let ar2 = ["I am Vitali", true, 31]; // переменную обьявляем здесь!!!!
...
let ar3 = ['Hello', 25, 'Son', 25]; // переменную обьявляем здесь!!!!

function f3() {
    document.querySelector('div.out-3').innerHTML = ar3.length;
}
...
function f4() {
     document.querySelector('div.out-4').innerHTML = `${ar4[0]} ${ar4[3]} ${ar4[8]}`;
}
...
let ar5 =[0,19,2,3,7,76,768];

function f5() {
    document.querySelector('div.out-5').innerHTML = ar5[0] + ar5[2] + ar5[3];
}
...
let ar6 = ['Виталий', 'водолей', 11, 'февраля', 1989];
...
function f8() {
    ...
    document.querySelector('div.out-8-1').innerHTML = ar8.length
}
...
function f9() {
    document.querySelector('div.out-9').innerHTML = ar9[ar9.length - 1];
}
...
function f10() {
    ...
    document.querySelector('div.out-10').innerHTML =  sum;
}
...
function f12() {
    let last = ar12[ar12.length-1];
    ar12[ar12.length - 1] = ar12[0];
    ar12[0] = last;
    let str ='';
    for(let i = 0; i < ar12.length; i++) {
        str += ar12[i] + ' ';
    }
    document.querySelector('div.out-12').innerHTML = str;
}
...
function f13() {
    ...
    document.querySelector('div.out-13').innerHTML = str;
}
...
function f14() {
    ...
    document.querySelector('div.out-14').innerHTML = str;
...
function f16() {
    ...
    for(let i = 0; i < ar16.length; i++) {
       if(ar16[i] % 2 === 0 && ar16[i] != 0) {
           ar16_odd[numOdd] = ar16[i];
           numOdd++;
       }
       else {
           ar16_even[numEven] = ar16[i];
           numEven++;
       }
    }
...
function f17() {
    ...
    document.querySelector('div.out-17').innerHTML = num;
}
...
function f18() {
    ...
    document.querySelector('div.out-18').innerHTML = max;
}
...
function f19() {
    ...
    for(let i = 0; i < ar19.length; i++) {
        if(ar19[i] < min) min = ar19[i];
    }
    let index = ar19.indexOf(min);
    document.querySelector('div.out-19').innerHTML = index;
}
...
function f20() {
    ...
    document.querySelector('div.out-20').innerHTML = sum;
}
