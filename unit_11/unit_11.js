...
function f15() {
    ...
    d15.indexOf(inp) === -1 ? d15.push(inp) : true;
...
function f19() {
    for(let i = 0; i < d19.length; i++ ) {
        maxString.length < d19[i].length ? maxString = d19[i] : false
    }
