const myRequest = (type, url, out, data) => {
	let myRequest = new XMLHttpRequest();
	if (type === 'GET') {
		myRequest.open(type, url, true);
	}
	if (type === 'POST') {
		myRequest.open(type, url, true);
	...
	myRequest.onreadystatechange = function() {
		if(this.readyState === 4 && this.status === 200) {
			document.querySelector(out).innerText = (this.responseText);
		}
	}
...
function t3() {
	myRequest('GET', `${url}?${key}&action=3&num1=3&num2=4`, '.out-3');
}
...
function t4() {
	myRequest('GET', `${url}?${key}&action=4&num1=3&num2=8`, '.out-4');
}
...
function t6() {
	myRequest('GET', `${url}?${key}&action=6&num1=3&num2=8`, '.out-6');
}
...
function t10() {
	myRequest('POST', url, '.out-10', `${key}&action=1`);
}
...
function t12() {
	myRequest('POST', url, '.out-12', `${key}&action=3&num1=23&num2=30`);
}
...
function t13() {
	myRequest('POST', url, '.out-13', `${key}&action=4&num1=23&num2=30`);
}
...
function t15() {
	myRequest('POST', url, '.out-15', `${key}&action=6&num1=3&num2=30`);
}
