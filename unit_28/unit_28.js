...
let goods2 = new Goods('Тыква', 21, 'img/2.png', 0.75);
goods2.draw('.out-4');
 ...
 let goods3 = new Goods2('Тыква', 21, 'img/2.png', 0.68, true);
 goods3.draw('.out-6');
 ...
 // Создайте объект на основе класса Valid и задайте ему имя и пароль длиной 5 символов. Запустите метод validate() и выведите в консоль свойство isValid.
  let valid = new Valid('Vitali', '12345');
  valid.validate();
 ...
 let valid1 = new Valid('Vitali', '1234567');
 valid1.validate();
 ...
 let valid3 = new Valid2('Hello', '1234567');
 valid3.validate();
 console.log(valid3);